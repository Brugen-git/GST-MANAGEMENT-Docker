...
#Creating a User class and defining attributes for the same
class User(db.Model):
...
#Creating a TaxPayer class and defining attributes for the same
...
#Creating a Tax class and defining attributes for the same
class Tax(db.Model):
    id = db.Column(db.Integer, primary_key=True)
